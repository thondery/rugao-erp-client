...
const ACTION_HANDLERS = {
  [types.PARTLIB_PART_LIST_BEGIN]: (state, action) => {
    return {
      ...state,
      getListPending: false,
      getListError: -1,
  ...
  [types.PARTLIB_PART_LIST_SUCCESS]: (state, action) => {
    ...
    return {
      ...
      getListPending: false,
      listData: data ? data.parts : null,
      species: data ? data.species : null
    }
  },
  [types.PARTLIB_PART_LIST_FAILURE]: (state, action) => {
    const { error } = action
  ...
  [types.PARTLIB_PART_EDIT_BEGIN]: (state, action) => {
    return {
      ...state,
      editPending: true,
      editError: -1,
  ...
  [types.PARTLIB_PART_EDIT_SUCCESS]: (state, action) => {
    const { payload } = action
    const { data, status } = payload
    return {
      ...state,
  ...
  [types.PARTLIB_PART_EDIT_FAILURE]: (state, action) => {
    const { error } = action
    const status = getStatusError(error)
    return {
      ...state,
  ...
  [types.PARTLIB_PART_ADD_BEGIN]: (state, action) => {
    return {
      ...state,
      addPending: true,
      addError: -1,
  ...
  [types.PARTLIB_PART_ADD_SUCCESS]: (state, action) => {
    const { payload } = action
    const { data, status } = payload
    return {
      ...state,
  ...
  [types.PARTLIB_PART_ADD_FAILURE]: (state, action) => {
    const { error } = action
    const status = getStatusError(error)
    return {
      ...state,
  ...
  [types.PARTLIB_PART_REMOVE_BEGIN]: (state, action) => {
    return {
      ...state,
      removePending: true,
      removeError: -1,
  ...
  [types.PARTLIB_PART_REMOVE_SUCCESS]: (state, action) => {
    const { payload } = action
    const { data, status } = payload
    return {
      ...state,
  ...
  [types.PARTLIB_PART_REMOVE_FAILURE]: (state, action) => {
    const { error } = action
    const status = getStatusError(error)
    return {
      ...state,
